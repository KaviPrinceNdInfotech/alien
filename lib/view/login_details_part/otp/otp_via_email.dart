...
import 'package:alien/view/login_details_part/name_verify/name_verification.dart';
...
class OtpVerificationEmail extends StatefulWidget {
  OtpVerificationEmail({Key? key}) : super(key: key);
            ...
            child: SafeArea(
              child: Column(
                  ...
                  children: [
                    ...
                    1.h.heightBox,
                    Text(
                      'Kindly  enter the  4-digit code sent to',
                      style: TextStyle(
                        wordSpacing: 1,
                        fontSize: 9.sp,
                        color: Colors.grey,
